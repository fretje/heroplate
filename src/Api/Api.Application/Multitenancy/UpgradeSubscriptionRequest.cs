...
public class UpgradeSubscriptionRequestHandler : IRequestHandler<UpgradeSubscriptionRequest, string>
{
    ...
    public Task<string> Handle(UpgradeSubscriptionRequest req, CancellationToken ct) =>
        _tenantService.UpdateSubscriptionAsync(req.TenantId, req.ExtendedExpiryDate, ct);
}