...
public class HeroTenantInfo : ITenantInfo
{
    public HeroTenantInfo()
    {
    }

    public HeroTenantInfo(string id, string name, string? connectionString, string adminEmail, string? issuer = null)
    {
        Id = id;
        Identifier = id;
        Name = name;
